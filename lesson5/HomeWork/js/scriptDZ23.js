...
console.log("--1.У вас є масив об’єктів fruts, і в кожному з них є name. Напишіть код, який перетворює їх в масив імен.------------");
const fruts = [
{ id: 0, name: "Apple" },
{ id: 1, name: "Tomat" },
{ id: 2, name: "Cherry" },
...
console.log("--2.Виведіть парні числа від 2 до 10, використовуючи цикл for.------------");
...
console.log(`--3.Замініть цикл "for" на "while"------------`);
